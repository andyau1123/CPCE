  ...
  <div class="container">
    ...
    <div class="jumbotron" >
      ...
      <div class="thumbnail_b text-center" style="max-width:320px;margin-bottom:5%">
        <a id="banner-reg-btn" href="" target="_blank" download>Download</a>
		<!-- img for conference Poster
        <a href="" target="_blank" download><img src="" style="width:100%" /></a>
		-->
      </div>
	  ...
	  <br />
      <div class="thumbnail_b text-center" style="max-width:320px;margin-bottom:5%">
        <a id="banner-reg-btn" href="images/posters/WorkshopPoster_PrintA4.png" target="_blank" download>Download</a>
		
        <a href="images/posters/WorkshopPoster_PrintA4.png" target="_blank" download><img src="images/posters/WorkshopPoster_PrintA4.png" style="width:100%;height=400" /></a>
		
	  </div>
	  <a href="images/posters/WorkshopPoster_PrintA4.png" target="_blank" download style="display: block; width: fit-content;"><img style="width:100%;max-width:200px;margin-bottom:10%" src="images/downloadbtn.png" alt="download" /></a>
      <br />
	  <br />
	  <hr/>
      <!-- Conf Booklets -->
      ...
      <!-- Special Issue -->
	   ...
	   <a href="downloads/Special_Issue_Flyer.pdf" target="_blank" download style="display: block; width: fit-content;"><img style="width:70%" src="images/Special_Issue.jpg" alt="pdffile" /></a>
      <br>
      <a href="downloads/Special_Issue_Flyer.pdf" target="_blank" download style="display: block; width: fit-content;"><img style="width:100%;max-width:200px;margin-bottom:10%" src="images/downloadbtn.png" alt="download" /></a>
      <hr/>
      <!-- Conf Photo Gallery -->
	  ...
	  <!--
      <iframe style="width:100%;height:60vmin" src="" title="Conference 2023 highlight" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
